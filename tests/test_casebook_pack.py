"""Regression checks for the glyphforge casebook."""
...
from casebook.harness import assert_expected, glyphforge_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(glyphforge_summary(), assert_expected())
